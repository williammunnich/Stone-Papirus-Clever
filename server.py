...
from spc import RockPaperScissors
...
async def on_message(message):
    ...
    if message.content.startswith("$play") and chat_only_used_once == 0:
        await message.channel.send("You are now playing Rock paper Scissors. Choose 'rock', 'paper', or 'scissors'")
        chat_only_used_once = 1
        while True:
            #print("chat program activated")
            #await message.channel.send("chat functionality activated, lets chat")
            ...
            #     await message.channel.send("Invalid input: Please choose 'rock', 'paper', or 'scissors'")
            #     await message.channel.send("Closing program")
            #     break
            ...
            win_lose = RockPaperScissors(previous_message)
            await message.channel.send(win_lose)
